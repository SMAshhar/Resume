        ...
        <div className="flex flex-col md:flex-row w-screen bg-[url('/bg/index.jpg')] bg-center justify-start">
            ...
            <div className="flex flex-col px-14 sm:p-2 w-screen justify-center items-center pb-16">
                <div className="flex flex-col sm:w-2/3 items-center sm:items-start">
                    <h1 className="text-4xl sm:text-7xl text-gray-700 pb-6">Works</h1>
                    <div className=" bg-white/[0.3] p-6">
                        <div>
                            <Link href='https://panaverse-dao-syedmuhammadashhar-gmailcom.vercel.app' className="text-xl sm:text-3xl mt-2 text-gray-900">
                        ...
                        {/* <div className="flex flex-col sm:w-2/3 sm:items-end sm:mr-20"> */}
                            <Link href='https://media-player-syedmuhammadashhar-gmailcom.vercel.app' className="text-xl sm:text-3xl mt-2 text-gray-900">
