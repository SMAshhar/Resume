    ...
    <div className="flex flex-col sm:flex-row bg-[url('/bg/index.jpg')] bg-center">
      ...
      <div className="flex flex-col  w-screen justify-center items-center">
        <div className="flex flex-col justify-center items-center md:items-starts w-2/3 pb-16">
          ...
          <div className="text-xl md:text-3xl mt-2 text-gray-700 ">Are you stuck? Do you need your website built and want the experience to be engaging and hassle free? You have reached the right place. I provide a one-stop shop with all the experties reqiured to build one from scratch to deployement.</div>
